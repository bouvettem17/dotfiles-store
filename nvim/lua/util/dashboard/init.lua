...
function M.getSeason()
    ...
    if currentMonth == "March" or currentMonth == "April" or currentMonth == "May" then
        season = "spring"
    elseif
        currentMonth == "June"
    ...
    elseif currentMonth == "November" then
        season = "thanksgiving"
    elseif currentMonth == "Decemeber" then
        season = "xmas"
    else
        season = "winter"
    end
...
function M.status()
    return require("util.dashboard.config").get_theme(season).statusline
end

function M.show()
    local theme = require("util.dashboard.config").get_theme(season)
