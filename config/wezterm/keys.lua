...
function M.setup(config)
	...
	config.keys = {
		...
		{ mods = M.mod, key = "=", action = wezterm.action.ToggleFullScreen },
		M.split_nav("resize", "SUPER", "h", "Right"),
		M.split_nav("resize", "SUPER", "l", "Left"),
		M.split_nav("resize", "SUPER", "k", "Up"),
		M.split_nav("resize", "SUPER", "j", "Down"),
